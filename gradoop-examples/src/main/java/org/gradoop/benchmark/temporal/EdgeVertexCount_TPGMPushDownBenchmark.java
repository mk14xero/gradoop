...
public class EdgeVertexCount_TPGMPushDownBenchmark extends AbstractRunner implements ProgramDescription {
  /**
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, EdgeVertexCount_TPGMPushDownBenchmark.class.getName());
   ...
   */
  @Override
  public String getDescription() { return EdgeVertexCount_TPGMPushDownBenchmark.class.getName();}
